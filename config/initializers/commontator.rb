...
Commontator.configure do |config|
  ...
  config.thread_moderator_proc = lambda { |thread, user| user.moderator? }
  ...
  #                   "student.care@#{Rails.application.class.parent.to_s.downcase}.com" }
  ...
  config.comment_url_proc = lambda { |thread, app_routes|
