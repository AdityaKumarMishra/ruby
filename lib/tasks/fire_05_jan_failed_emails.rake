namespace :fire_05_jan_failed_emails do
  task fetch_details: :environment do
    puts "=============== Task Start ==============="

    tickets = Ticket.where('created_at BETWEEN ? AND ?', ("05/01/2021").to_date.beginning_of_day, ("05/01/2021").to_date.end_of_day)
    ...
    essay_responses = EssayResponse.where('created_at BETWEEN ? AND ?', ("05/01/2021").to_date.beginning_of_day, ("05/01/2021").to_date.end_of_day)
    ...
    essay_tutor_responses = EssayTutorResponse.where('created_at BETWEEN ? AND ?', ("05/01/2021").to_date.beginning_of_day, ("05/01/2021").to_date.end_of_day)
    ...
    email_arr = ["jonicafernandes@hotmail.com", "mitchmorfea@gmail.com", "brandonmiller2706@gmail.com", "gurfinkelyuval@gmail.com", "fanulic@outlook.com", "panada714714@gmail.com", "gurfinkelyuval@gmail.com", "fanulic@outlook.com", "mitchmorfea@gmail.com"].uniq
