namespace :fire_13_dec_failed_emails do
  task fetch_details: :environment do
    puts "=============== Task Start ==============="
    users = User.where('created_at BETWEEN ? AND ?', ("29/12/2020").to_date.beginning_of_day, ("29/12/2020").to_date.end_of_day)
    users.each do |user|
    ...
    tickets = Ticket.where('created_at BETWEEN ? AND ?', ("29/12/2020").to_date.beginning_of_day, ("29/12/2020").to_date.end_of_day)
    ...
    essay_responses = EssayResponse.where('created_at BETWEEN ? AND ?', ("29/12/2020").to_date.beginning_of_day, ("29/12/2020").to_date.end_of_day)
