module RatyRatesHelper
  def rating_for(rateable_obj, dimension=nil, options={})
    ...
    star_on      = options[:star_on]      || image_path('https://gradready.s3.ap-southeast-2.amazonaws.com/static/star-on.png')
    star_off     = options[:star_off]     || image_path('https://gradready.s3.ap-southeast-2.amazonaws.com/static/star-off.png')
    star_half    = options[:star_half]    || image_path('https://gradready.s3.ap-southeast-2.amazonaws.com/static/star-half.png')
    cancel       = options[:cancel]       || false
    cancel_place = options[:cancel_place] || 'left'
    cancel_hint  = options[:cancel_hint]  || 'Cancel current rating!'
    cancel_on    = options[:cancel_on]    || image_path('https://gradready.s3.ap-southeast-2.amazonaws.com/static/cancel-on.png')
    cancel_off   = options[:cancel_off]   || image_path('https://gradready.s3.ap-southeast-2.amazonaws.com/static/cancel-off.png')
    ...
    if options[:imdb_avg] && readOnly
      content_tag :div, '', :style => "background-image:url('https://gradready.s3.ap-southeast-2.amazonaws.com/static/mid-star.png');width:61px;height:57px;margin-top:10px;" do
  ...
  def imdb_style_rating_for(rateable_obj, user, options = {})
    ...
    content_tag :div, '', :style => "background-image:url('https://gradready.s3.ap-southeast-2.amazonaws.com/static/big-star.png');width:81px;height:81px;margin-top:10px;" do
