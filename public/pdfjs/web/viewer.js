...
var PDFPageView = (function PDFPageViewClosure() {
  ...
  PDFPageView.prototype = {
    ...
    draw: function PDFPageView_draw() {
      ...
      var wmCookie = decodeURIComponent(getCookie("textbook_watermark"));
      ...
      imageObj.onload = function(){
        ...
        //  commented out this line to remove GR logo in watermark.
        ...
        for (var i = 0; i<words.length; i++)
          wmContext.fillText(words[i], 180, 180 + (i*42) );
      };
      imageObj.src = "logo.png";

      // change the origin coordinate to the middle of the context
      //wmContext.translate(1*canvas.width/16, (1*canvas.height/2));
      // rotate the context (so it's rotated around its center)
      //wmContext.rotate(-Math.PI/2);
      // as the origin is now at the center, just need to center the text

      //wmContext.fillText(wmCookie,-width/2,(height/2));
